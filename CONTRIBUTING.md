...
Vellum is released. A drawing lives in the browser's IndexedDB (`ProjectFile`, currently version 2) and in exported SVG. A change to either keeps documents people already have opening: bump the version and read the previous one.
