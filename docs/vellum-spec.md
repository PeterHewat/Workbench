...
- **Nothing needs a keyboard.** The bar beside the selection carries delete, duplicate, z-order,
  ...
  rather than the whole shape, and offers only what acts on the anchor: link or break its handles,
  split, close/open, delete the point. The selection bar also leads with two keyboard stand-ins:
  ...
  everything**, and carries **copy**. On a touch screen with nothing selected the bar stays up,
